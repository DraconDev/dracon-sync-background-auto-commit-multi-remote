# dracon-sync v0.113.60 (2026-09-17)

Invisible git sync daemon for deterministic AI-assisted development.

## What's Changed

- Bump version to 0.113.60
- (See CHANGELOG.md for the full list of changes in this release)

## Install

```bash
cargo install dracon-sync --version 0.113.60
```
...
**Full Changelog**: https://github.com/DraconDev/dracon-utilities/compare/dracon-sync-v0.113.59...v0.113.60
