# dracon-sync v0.113.56 (2026-09-15)

Invisible git sync daemon for deterministic AI-assisted development.

## What's Changed

- Bump version to 0.113.56
- (See CHANGELOG.md for the full list of changes in this release)

## Install

```bash
cargo install dracon-sync --version 0.113.56
```
...
**Full Changelog**: https://github.com/DraconDev/dracon-utilities/compare/1.0.0...v0.113.56
