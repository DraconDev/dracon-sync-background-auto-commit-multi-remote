# dracon-sync v0.113.71 (2026-09-18)

Invisible git sync daemon for deterministic AI-assisted development.

## What's Changed

- Bump version to 0.113.71
- (See CHANGELOG.md for the full list of changes in this release)

## Install

```bash
cargo install dracon-sync --version 0.113.71
```
...
**Full Changelog**: https://github.com/DraconDev/dracon-utilities/compare/dracon-sync-v0.113.70...v0.113.71
