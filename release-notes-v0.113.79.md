# dracon-sync v0.113.79 (2026-09-19)

Invisible git sync daemon for deterministic AI-assisted development.

## What's Changed

- Bump version to 0.113.79
- (See CHANGELOG.md for the full list of changes in this release)

## Install

```bash
cargo install dracon-sync --version 0.113.79
```
...
**Full Changelog**: https://github.com/DraconDev/dracon-utilities/compare/dracon-sync-v0.113.78...v0.113.79
