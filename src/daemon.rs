...
/// Persisted throttle state round-trips live entries, drops
/// expired deadlines and orphan streaks, and fails open on
/// garbage. v0.113.79 (restart must not re-arm throttled alerts).
#[test]
